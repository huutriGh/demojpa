...
a persistence unit "demojpaPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/org/aptech/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "demojpa/pom.xml":
...
artifacts ("demojpa-ejb.jar" and "demojpa-web.war") are already built. You can build
